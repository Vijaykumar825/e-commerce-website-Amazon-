...
loadProducts(renderPreoductsGrid);

function renderPreoductsGrid(){
  let productHTML ='';
  ...
  document.querySelector('.js_product_grid').innerHTML = productHTML;

  updateCartquantity();

  //function which updates the cart quantity
